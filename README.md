...
TON = 3 * 0.1 = 0.3
TOFF = 3 * 0.1 = 0.3
TOTAL TIME = TON+TOFF = 0.6
FREQUENCY = 1/(TOTAL TIME) = 1.66 KHZ
DUTY CYCLE = TON/TON+TOFF = 50%
```
### FOR PULSE AT 7500 :
```
TON = 2.2 * 0.2 = 0.44
TOFF= 0.8 * 0.2 = 0.16
TOTAL TIME = 0.6
FREQUENCY = 1/(TOTAL TIME) = 1.66
DUTY CYCLE = TON/TON+TOFF = 73%
```
### FOR PULSE AT 2500 :
```
TON = 0.8 * 0.2 = 0.16
TOFF = 2.2 * 0.2 =0.44
TOTAL TIME = 0.6 MS
FREQUENCY = 1/(TOTAL TIME) = 1.6 KHZ
DUTY CYCLE = TON/TON+TOFF = 26%
```
